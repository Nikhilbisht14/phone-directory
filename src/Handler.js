        ...
        return (
            <div className="main-container">
                <div className="number-cards-container">
                    ...
                    <NumberCard cardClickHandler="displayRandomNumbers()"  id={this.props.idArr[0]} color={this.props.colorsArr[0]} />
                    <NumberCard cardClickHandler="displayRandomNumbers()" id={this.props.idArr[1]} color={this.props.colorsArr[1]} />
                    <NumberCard cardClickHandler="displayRandomNumbers()" id={this.props.idArr[2]} color={this.props.colorsArr[2]} />
                </div>
                {
                ...
                <input onClick={this.tryLuckClickHandler.bind(this)} id="tryYourLuckBtn" className="custom-btn" type="button" value="Try Your Luck" />
            </div>
        )
    }
}
